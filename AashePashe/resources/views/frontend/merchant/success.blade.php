        ...
        <div class="login-box">
            ...
            <div class="panel panel-primary" style="border: 1px solid #48a0d6">
                ...
                <div class="panel-body">
                    ...
                    <form action="{{ URL::to('merchant/verification') }}" method="post">
                        {{ csrf_field() }}
                        <input type="hidden" name="random_code" value="{{ $random_code }}" />
                        <div class="form-group has-feedback">
                            <input type="text" class="form-control" id="code" name="code" value="{{ old('code') }}" placeholder="Enter Verification Code" required="required">
                    ...
                    <br>
                    <center>
                        <a href="{{ URL::to('/') }}" style="font-size: 16px;text-align: center"><i class="fa fa-home"></i> Back Home</a><br>
                    </center>
                </div>
            </div>
        </div>
