                                        ...
                                        <div class="row">
                                            <div class="col-md-12">
                                                <div class="col-md-6">
                                                    ...
                                                    <form role="form" method="POST" action="{{ URL::to('portal/slider/update') }}" enctype="multipart/form-data">
                                                        {{ csrf_field() }}
                                                        <input type="hidden" name="slider_id" value="{{ $data_list->slider_id }}" />
                                                        <div class="form-group">
                                                            <label class="control-label" for="details">Text</label>
                                                            <input type="text" class="form-control" name="details" id="details" value="{{ $data_list->details }}" />
