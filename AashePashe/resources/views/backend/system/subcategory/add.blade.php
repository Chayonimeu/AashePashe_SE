                        ...
                        <div class="col-md-12">
                            <div class="panel-group">
                                <div class="panel panel-primary">
                                    <div class="panel-heading panel-style"><i class="fa fa-clone"></i> Add New Sub Category For <span style="color: #1E4770">{{ $category_info->name }}</span>
                                    ...
                                    <div class="panel-body">
                                        <div class="row">
                                            <div class="col-md-12">
                                                <div class="col-md-6">
                                                    <form role="form" class="" method="POST" action="{{ URL::to('portal/subcategory/store') }}" enctype="multipart/form-data">
                                                        {{ csrf_field() }}
