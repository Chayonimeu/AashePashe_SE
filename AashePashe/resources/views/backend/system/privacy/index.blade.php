                                            ...
                                            <div class="col-md-8">
                                                <div class="nav-tabs-custom">
                                                    <ul class="nav nav-tabs">
                                                        ...
                                                        <li class="active"><a href="{{ URL::to('portal/privacy') }}">Privacy & Policy</a></li>
                                                    ...
                                                    <div class="tab-content">
                                                        <div class="active tab-pane">
                                                            <div class="box box-primary">
                                                                ...
                                                                <div class="box-body">
                                                                    <form class="" action="{{ url('portal/privacy/update') }}" method="post" enctype="multipart/form-data">
                                                                        {{ csrf_field() }}
                                                                        <input type="hidden" name="system_settings_id" value="{{ $system_info->system_settings_id }}">
                                                                        <div class="form-group">
                                                                            <textarea class="form-control" name="privacy" id="privacy" required="required">{{ $system_info->privacy }}</textarea>
                                                                            @if ($errors->has('privacy'))
                                                                            <span class="help-block">
                                                                                <strong><i class="fa fa-warning"></i> {{ $errors->first('privacy') }}</strong>
                                                                            </span>
                                                                            @endif
                                                                        </div>
                                                                        <div class="form-group">
