                                ...
                                <div class="panel panel-primary">
                                    ...
                                    <div class="panel-body">
                                        <div class="row">
                                            <div class="col-md-12">
                                                <div class="col-md-6">
                                                    <form role="form" class="" method="POST" action="{{ URL::to('portal/property/update') }}" enctype="multipart/form-data">
                                                        {{ csrf_field() }}
                                                        <input type="hidden" name="property_id" value="{{ $data_list->property_id }}" />
                                                        ...
                                                        <div class="form-group">
                                                            ...
                                                            <textarea maxlength="255" class="form-control" id="details" name="details" >{{ $data_list->details }}</textarea>
