                                ...
                                <div class="panel panel-primary">
                                    ...
                                    <div class="panel-body">
                                        <div class="row">
                                            <div class="col-md-12">
                                                <div class="col-md-6">
                                                    <form role="form" class="" method="POST" action="{{ URL::to('portal/category/store') }}" enctype="multipart/form-data">
                                                        {{ csrf_field() }}
                                                        ...
                                                        <div class="form-group">
                                                            ...
                                                            <select class="form-control select2" name="type_name" id="type_name" required>
                                                                ...
                                                                <option value="{{ $data->name }}"{{ (old('type_name') == $data->name) ? 'selected' : '' }}>{{ $data->name }}</option>
                                                                @endforeach
                                                            </select>
