                                            ...
                                            <div class="col-md-8">
                                                <div class="nav-tabs-custom">
                                                    <ul class="nav nav-tabs">
                                                        ...
                                                        <li class="active"><a href="{{ URL::to('portal/about') }}">About Us</a></li>
                                                    ...
                                                    <div class="tab-content">
                                                        <div class="active tab-pane">
                                                            <div class="box box-primary">
                                                                ...
                                                                <div class="box-body">
                                                                    <form class="" action="{{ url('portal/about/update') }}" method="post" enctype="multipart/form-data">
                                                                        {{ csrf_field() }}
                                                                        <input type="hidden" name="system_settings_id" value="{{ $system_info->system_settings_id }}">
                                                                        <div class="form-group">
                                                                            <textarea class="form-control" name="about_us" id="about_us" required="required">{{ $system_info->about_us }}</textarea>
                                                                            @if ($errors->has('about_us'))
                                                                            <span class="help-block">
                                                                                <strong><i class="fa fa-warning"></i> {{ $errors->first('about_us') }}</strong>
                                                                            </span>
                                                                            @endif
                                                                        </div>
                                                                        <div class="form-group">
